      ...
      switch ($_item) {
        ...
        case 'ui_texts':
          try {
            ...
            $data['title_name'] = ($title_name = $redis->get('TITLE_NAME')) ? $title_name : "$mailcow_hostname - CyKrome Workspaces";
            $data['main_name'] = ($main_name = $redis->get('MAIN_NAME')) ? $main_name : "CyKrome Workspaces";
